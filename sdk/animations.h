...
// Exported from SA-MP 0.3.7DL-R1

// Apperently this is used in client and server side too with 1812 elements
// with string length of 36, but actually 30 is the max that is used here

const char g_szAnimNames[1812][31] = {
